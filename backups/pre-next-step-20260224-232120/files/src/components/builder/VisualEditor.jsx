 ...
 */
function VisualEditor({ config, onConfigChange, accentColor, onAccentColorChange, logoSrc = '', onLogoSrcChange = null }) {
  ...
  return (
    <div style={styles.container}>
      <h3 style={styles.sectionTitleFirst}>Visual Settings</h3>
