          ...
          {steps.map((step, index) => (
            <React.Fragment key={step.id}>
              ...
              {index < steps.length - 1 && (
                <div style={{ ...styles.stepConnector, ...(isMobileLayout ? styles.stepConnectorMobile : {}) }} />
              )}
            </React.Fragment>
          ))}
          </div>

          {/* Right side — Customizer CTA */}
          <div style={{ flex: 1, display: 'flex', 
            justifyContent: 'flex-end', alignItems: 'center' }}>
            {!isMobileLayout && currentStep >= 4 && (
              <button
                type="button"
                ...
                onMouseOver={e => { e.currentTarget.style.backgroundColor = zenPalette.gold + '15'; e.currentTarget.style.borderColor = zenPalette.gold; }}
                onMouseOut={e => { e.currentTarget.style.backgroundColor = 'transparent'; e.currentTarget.style.borderColor = zenPalette.gold + '55'; }}
              >
                ✦ Im Customizer bearbeiten
              </button>
            )}
          </div>
        </div>
                ...
                {/* Left Panel - Preview */}
                  {(!isMobileLayout || mobilePanel === 'preview') && (
                    <div style={styles.previewPanel}>
                      <div style={styles.templateQuickSwitch}>
                        ...
                        {pendingTemplateId && (
                          <div style={styles.templateApplyPanel}>
                            <p style={styles.templateApplyText}>
                              Template-Vorschau aktiv: Nur Style behalten oder komplett uebernehmen.
                            </p>
                            <div style={styles.templateApplyActions}>
                              <button
                                type="button"
                                style={styles.templateApplyGhost}
                              ...
                              <button
                                type="button"
                                style={styles.templateApplyPrimary}
                  ...
                  {(!isMobileLayout || mobilePanel === 'design') && (
                    <div style={styles.editorPanel}>
                      <div style={styles.editorQuickPanel}>
                        ...
                        {hasPendingLogoApply && (
                          <div style={styles.templateApplyPanel}>
                            <p style={styles.templateApplyText}>
                              Logo-Vorschau aktiv. Wenn es passt, Logo uebernehmen.
                            </p>
                            <button
                              type="button"
                              style={styles.templateApplyPrimary}
